...
const Signup = ()=>{
    ...
    const uploadFields = ()=>{
        ...
        .then(data=>{
          ...
          {
              M.toast({html: "Saved successfuly",classes:"#00e676 green accent-3"})
              history.push('/signin')
          }
        }).catch(err=>{
            console.log(err)
...
return (
   <div className="mycard">
        <div className="card auth-card">
            ...
            <button className="btn waves-effect waves-light #1e88e5 blue darken-1" onClick={()=>PostData()}>Signup 
           </button>
           <h5>
